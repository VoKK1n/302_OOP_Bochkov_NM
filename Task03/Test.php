...
function runTest()
{
    ...
    */
    ...
    $student1->setName("Стас")->setLastname("Тюрин")->setFaculty("ФМиИТ")->setCourse(2)->setGroup(302);

    $student2 = new Student();
    $student2->setName("Кирилл")->setLastname("Назаров")->setFaculty("ФМиИТ")->setCourse(2)->setGroup(302);
