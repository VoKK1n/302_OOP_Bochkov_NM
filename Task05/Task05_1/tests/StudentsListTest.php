...
class StudentsListTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$student1->setLastname('Bochkov')->setName('Nikita')->setFaculty('IT')->setCourse(2)->setGroup(302);
        self::$student2 = new Student();
        self::$student2->setLastname('Artamonov')->setName('Egor')->setFaculty('EF')->setCourse(2)->setGroup(302);
        self::$student3 = new Student();
        self::$student3->setLastname('Vedyashkin')->setName('aAlexey')->setFaculty('IT')->setCourse(2)->setGroup(304);
    }
